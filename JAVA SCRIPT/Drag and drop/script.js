...
document.querySelectorAll('.kanban-card').forEach(card => {
    card.addEventListener('dblclick', () => {
        const editar = prompt("Digite o novo título do card" , card.querySelector('.card-title').textContent);
        card.querySelector('.card-title').textContent = editar;
...
// prompt("Digite o novo título do card:")